...
class Activity13 {
    public static <JavascriptExecutor> void main(String[] args) {
        ...
        System.out.println("Check displayed ? " + chkbox.isDisplayed());
        chkboxbt.click();

        // Wait for the chkbox to disappear
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("dynamicCheckbox")));
        System.out.println("Check displayed after clicking button ? " + chkbox.isDisplayed());
//        System.out.println(chkboxbt.isDisplayed());
